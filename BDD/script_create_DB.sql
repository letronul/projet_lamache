drop database if exists projet_bd;
...
CREATE TABLE User(
        id_user      Int NOT NULL ,drop database if exists projet_bd;
create database projet_bd;
use projet_bd;
...
alter table User modify id_user Int auto_increment;
alter table Matiere modify id_matiere Int auto_increment;
alter table Classe modify id_classe Int auto_increment;
alter table eleve modify id_user Int auto_increment;
alter table note modify id_note Int auto_increment;
alter table Formation modify id_formation Int auto_increment;
        login        Varchar (128) NOT NULL,
        password     Varchar (128) NOT NULL ,
        nom          Varchar (64) ,
        prenom       Varchar (64) ,
